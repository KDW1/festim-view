# Code copied from the 2d_permeation FESTIM example
import warnings
...
surface_2=F.SurfaceSubdomain(id=4, locator=lambda x: np.isclose(x[0], 0.0))
...
interface_1=F.Interface(id=5, subdomains=[volume_1, volume_2], penalty_term=100)
...
vtx_export_1 = F.VTXSpeciesExport(
  filename=f"out/field_export.bp",
